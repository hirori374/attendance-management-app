...
@section('content')
    <div class="attendance__detail">
        <div class="detail__inner">
            ...
            @elseif ($attendance)
                <form action="{{ route('admin.correction', ['id' => $attendance->id]) }}" method="post" class="correction-request__form">
                    @csrf
                    @method('PATCH')
                    <table class="detail__table">
                        <tr class="table__row">
            ...
            @elseif(!$attendance)
                <form action="{{ route('admin.attendance.create', ['userId' => $user->id]) }}" method="post" class="correction-request__form">
                    @csrf
                    <table class="detail__table">
                        <tr class="table__row">
                            <th>名前</th>
